...
- [Установка](#Установка)
    ...
    - [Шаг 6: Настройка доступа](#Шаг-6-Настройка-доступа)
    - [Шаг 7: Настройка Redis](#Шаг-7-Настройка-Redis)
    - [Шаг 8: Запуск сервера](#Шаг-8-Запуск-сервера)
...
Для хранения путей к файлам используется кэширование с помощью Redis. Перед началом работы выполните базовую настройку в файле конфигурации:
```bash
Config/.env
```
Пример настроек:
